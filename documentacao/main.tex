...
Dandara: Responsável pela infraestrutura do Banco de Dados (scripts DDL/DML), elaboração dos diagramas UML (Diagrama de Classes e Diagrama Entidade-Relacionamento) e desenvolvimento frontend do sistema,  elaboração da documentação dos testes de endpoint e de funcionalidades.

Rayssa: Responsável pela análise de requisitos, elaboração dos diagramas de casos de uso e de sequências, desenvolvimento backend, controle de versão, debug e testes de endpoint, elaboração da documentação do sistema em LaTeX.
